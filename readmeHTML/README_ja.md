...
## 🎯 目的
Symfony（PHP）とVueJSを使用して、カスタマイズされたSteamユーザープロフィールを再現する動的なウェブサイトを作成します。

### Symfony
- ユーザー管理（ユーザー名、アバターなど） ✅
- ゲームおよびゲーム統計の管理 ✅
- VueJS用の最小限のAPIの実装 ✅
- クリーンでリレーショナルな基本構造の構築 ✅

#### 🎯 サブ目標
- 日付をローカライズされた言語で表示 ✅
- アバターのアップロード機能 ✅
- ユーザーの好みに応じて言語を変更可能にする ✅
- 管理者のみがCRUDを閲覧できるようにセキュリティを追加 ✅

### VueJS 
- 複数コンポーネントの利用 ✅
- ルーターの利用 ✅
- piniaの利用 ✅
- サイトの一部はSymfonyのAPIを利用して動的にデータを表示 ❌
